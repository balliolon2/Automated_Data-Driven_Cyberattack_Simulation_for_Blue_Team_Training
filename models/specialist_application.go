...
type SpecialistApplication struct {
	...
	LinkedInURL     string     `gorm:"column:linkedin_url;type:varchar" json:"linkedin_url,omitempty"`
	...
	Reviewer        *User      `gorm:"foreignKey:ReviewedBy;references:UserID;constraint:-" json:"reviewer,omitempty"`
